...
$messenger->setTypingStatus($event->getSenderId(), \Tgallice\FBMessenger\TypingIndicator::MARK_SEEN);

// Turn on typing indicator to let users know you are processing their request
$messenger->setTypingStatus($event->getSenderId(), \Tgallice\FBMessenger\TypingIndicator::TYPING_ON);
...
$messenger->setTypingStatus($event->getSenderId(), \Tgallice\FBMessenger\TypingIndicator::TYPING_OFF);
